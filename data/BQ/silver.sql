...
CREATE TABLE IF NOT EXISTS `avd-practice-1.Project_Sliver.departments` (
    Dept_Id STRING,
    SRC_Dept_Id STRING,
    Name STRING,
    datasource STRING,
...
TRUNCATE TABLE `avd-practice-1.Project_Sliver.departments`;

-- 3. full load by Inserting merged Data 
INSERT INTO `avd-practice-1.Project_Sliver.departments`
SELECT DISTINCT 
...
CREATE TABLE IF NOT EXISTS `avd-practice-1.Project_Sliver.providers` (
    ProviderID STRING,
    FirstName STRING,
    LastName STRING,
...
-- 2. Truncate Silver Table Before Inserting 
TRUNCATE TABLE `avd-practice-1.Project_Sliver.providers`;

-- 3. full load by Inserting merged Data 
INSERT INTO `avd-practice-1.Project_Sliver.providers`
SELECT DISTINCT 
    ProviderID,
    FirstName,
    LastName,
...
CREATE TABLE IF NOT EXISTS `avd-practice-1.Project_Sliver.patients` (
    Patient_Key STRING,
...
CREATE OR REPLACE TABLE `avd-practice-1.Project_Sliver.quality_checks` AS
SELECT DISTINCT 
...
MERGE INTO `avd-practice-1.Project_Sliver.patients` AS target
USING `avd-practice-1.Project_Sliver.quality_checks` AS source
...
DROP TABLE IF EXISTS `avd-practice-1.Project_Sliver.quality_checks`;

-------------------------------------------------------------------------------------------------------

-- 1. Create transactions Table in BigQuery
CREATE TABLE IF NOT EXISTS `avd-practice-1.Project_Sliver.transactions` (
...
-- 3. Apply SCD Type 2 Logic with MERGE
MERGE INTO `avd-practice-1.Project_Sliver.transactions` AS target
USING `avd-practice-1.Project_Sliver.quality_checks` AS source
...
CREATE TABLE IF NOT EXISTS `avd-practice-1.Project_Sliver.encounters` (
...
CREATE OR REPLACE TABLE `avd-practice-1.Project_Sliver.quality_checks_encounters` AS
SELECT DISTINCT 
...
-- 3. Apply SCD Type 2 Logic with MERGE
MERGE INTO `avd-practice-1.Project_Sliver.encounters` AS target
USING `avd-practice-1.Project_Sliver.quality_checks_encounters` AS source
...
-- 4. DROP quality_check table
DROP TABLE IF EXISTS `avd-practice-1.Project_Sliver.quality_checks_encounters`;

-------------------------------------------------------------------------------------------------------

-- 1. Create the Claims Table in BigQuery
CREATE TABLE IF NOT EXISTS `avd-practice-1.Project_Sliver.claims` (
    Claim_Key STRING,
    SRC_ClaimID STRING,
...
CREATE OR REPLACE TABLE `avd-practice-1.Project_Sliver.quality_checks_claims` AS
SELECT 
...
-- 3. Apply SCD Type 2 Logic with MERGE
MERGE INTO `avd-practice-1.Project_Sliver.claims` AS target
USING `avd-practice-1.Project_Sliver.quality_checks_claims` AS source
...
-- 4. DROP quality_check table
DROP TABLE IF EXISTS `avd-practice-1.Project_Sliver.quality_checks_claims`;

-------------------------------------------------------------------------------------------------------

-- 1. Create the CP Codes Silver Table in BigQuery
CREATE TABLE IF NOT EXISTS `avd-practice-1.Project_Sliver.cpt_codes` (
    CP_Code_Key STRING,
...
CREATE OR REPLACE TABLE `avd-practice-1.Project_Sliver.quality_checks_cpt_codes` AS
SELECT 
...
-- 3. Apply SCD Type 2 Logic with MERGE
MERGE INTO `avd-practice-1.Project_Sliver.cpt_codes` AS target
USING `avd-practice-1.Project_Sliver.quality_checks_cpt_codes` AS source
...
-- 4. DROP quality_check table
DROP TABLE IF EXISTS `avd-practice-1.Project_Sliver.quality_checks_cpt_codes`;
